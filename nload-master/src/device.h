...
class Device
{
    public:
        ...
        std::string determineTrafficStatus();
    ...
    private:
        ...
        void printDataValue(Window& window, int x, int y, const std::string& description, unsigned long long value, bool applyUnitConversion);
